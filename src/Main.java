...
public class Main {
	...
	public static void main(String[] args) {
		...
		p2.put(new Coordinate(-3, -11), new TileSquare(Set.of(WildlifeToken.BEAR, WildlifeToken.ELK), WildlifeToken.ELK, Landscape.FOREST));
		p2.put(new Coordinate(-3, -2), new TileSquare(Set.of(WildlifeToken.BEAR, WildlifeToken.ELK), WildlifeToken.ELK, Landscape.FOREST));
